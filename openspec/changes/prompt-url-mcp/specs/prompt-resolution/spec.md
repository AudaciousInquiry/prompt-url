...
created:
  ...
  llm:
    ...
    version: '4.6'
  prompt_uri: >-
    prompt://github-copilot/95602ecf-b509-42b5-b5c4-cefb007525df/2026-07-19T14:26:20.047Z
  summary: Add prompt-resolution capability spec
updated:
  - date: '2026-07-19T18:28:06.094Z'
    user: boonek
    agent:
      name: github-copilot
      version: '1.0'
    llm:
      ...
      version: '4.6'
    prompt_uri: >-
      prompt://github-copilot/95602ecf-b509-42b5-b5c4-cefb007525df/2026-07-19T18:28:06.095Z
    summary: Add Purpose section naming the resolve_prompt MCP tool
---
## Purpose

Defines the behavior of the **`resolve_prompt`** MCP tool, which resolves a `prompt://`
URI to the original user message that caused an AI-generated artifact.
